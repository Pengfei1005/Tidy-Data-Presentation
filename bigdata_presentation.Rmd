...
```{R, echo = F, out.width = '75%',eval = TRUE}
knitr::include_graphics("weird_data.jpg")
```
...
```{r}
GDP_and_Tax = data.frame(City = rep(c("Beijing", "Hong Kong", "New York"), each =2),
  'GDP'= runif(6, 100, 200),
...
```{r}
Energy_and_Industry = data.frame(City = rep(c("Beijing", "Hong Kong", "New York"), each =2),
